...
# Open dataset ----
boots <-
    arrow::open_csv_dataset("data/train.csv")
...
xgb.save(xg_model, "models/xgboost_full.model")
...
fs::dir_create("results/xg_full_gpu")
...
key_preds <- predict(xg_model, x_key, type = "prob")
summary(key_preds)
...
arrow::write_parquet(key_res, "results/xgboost_gpu_v1.3.parquet")
